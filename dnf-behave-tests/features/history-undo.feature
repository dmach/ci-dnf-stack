...
Scenario: Handle missing packages required for undoing the transaction
   ...
   Then the exit code is 0
    ...
    And History is following
     ...
     And stderr contains "The following problems occurred while running a transaction:"
     And stderr contains "Cannot find rpm nevra \"flac-1.3.2-8.fc29.x86_64\"."
     And stderr contains "Cannot find rpm nevra \"wget-1.19.5-5.fc29.x86_64\"."
...
Scenario: Missing packages are skipped if --skip-unavailable is specified
   ...
   Then I execute dnf with args "update"
    Then the exit code is 0
     ...
     Then the exit code is 0
     And Transaction is empty
     And stderr contains "Warning, the following problems occurred while running a transaction:"
     And stderr contains "  Cannot find rpm nevra \"flac-1.3.2-8.fc29.x86_64\"."
     And stderr contains "  Cannot find rpm nevra \"wget-1.19.5-5.fc29.x86_64\"."
